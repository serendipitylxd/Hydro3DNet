...
class FSHNet_base(nn.Module):
    ...
    def feature_diffusion(self, x, batch_dict):
        ...
        for gidx, inside_mask in enumerate(group_inside_mask):
            ...
            #print("len(group_class_names) =", len(self.group_class_names), "group_class_names =",
            #      self.group_class_names)
            #print("len(group_pooling_kernel_size) =", len(self.group_pooling_kernel_size),
            #      "group_pooling_kernel_size =", self.group_pooling_kernel_size)
