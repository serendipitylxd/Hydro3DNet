        ...
        for stage_id in range(self.stage_num):
            ...
            if stage_id < self.stage_num - 1:
                ...
                if self.reduction_type == 'linear':
                    ...
                    key_padding_mask = torch.zeros((pooled_voxel_num, pool_volume), device=prepool_features.device,
                                                   dtype=torch.bool)
...
class Stage_ReductionAtt_Block(nn.Module):
    ...
    def forward(self, x, key_padding_mask):
        ...
        query = src.clone()
        #print("key_padding_mask type:", type(key_padding_mask))
        #if isinstance(key_padding_mask, torch.Tensor):
        #    print("key_padding_mask dtype:", key_padding_mask.dtype)
