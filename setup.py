...
#print("CUDA_HOME in setup.py:", os.environ.get("CUDA_HOME"))
os.environ.setdefault("CUDA_HOME", "/usr/local/cuda-11.8")
os.environ.setdefault("CUDA_PATH", "/usr/local/cuda-11.8")
#print("CUDA_HOME in setup.py:", os.environ.get("CUDA_HOME"))
#print("CUDA_PATH in setup.py:", os.environ.get("CUDA_PATH"))
