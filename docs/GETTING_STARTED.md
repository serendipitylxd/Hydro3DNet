...
Currently we provide the dataloader of TROUT, KITTI, NuScenes, Waymo, Lyft and Pandaset. If you want to use the TROUT dataset, Please refer to our [TROUT dataset template](TROUT_DATASET_TUTORIAL.md). If you want to use a custom dataset, Please refer to our [custom dataset template](CUSTOM_DATASET_TUTORIAL.md).

### TROUT Dataset
* Please download the official [PCDet_TROUT_data](https://drive.google.com/file/d/1JCClYd6egTm0AxXtW80L18AySgG45_og/view?usp=sharing) and 
